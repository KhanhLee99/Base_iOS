...
//  Copyright © 2021 Vien. All rights reserved.
//
...
public class ALRT {
    ...
    public func show(
        ...
        let sourceViewController: UIViewController? = {
            let viewController = viewControllerToPresent ?? UIApplication.shared.topMMostViewController()
...
private extension UIViewController {
    func topMMostViewController() -> UIViewController {
        if let presented = presentedViewController {
            return presented.topMMostViewController()
        }

        if let navigation = self as? UINavigationController {
            return navigation.visibleViewController?.topMMostViewController() ?? navigation
        }

        if let tab = self as? UITabBarController {
            return tab.selectedViewController?.topMMostViewController() ?? tab
        }
...
private extension UIApplication {
    func topMMostViewController() -> UIViewController? {
        ...
        return keyWindow.rootViewController?.topMMostViewController()
    }
}
